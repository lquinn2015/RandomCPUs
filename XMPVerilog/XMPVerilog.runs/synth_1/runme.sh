...
HD_PWD='C:/Users/msg23/LearningVerilog/XMPVerilog/XMPVerilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPUModel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPUModel.tcl
